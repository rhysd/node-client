export interface Nvim extends NodeJS.EventEmitter {
  ...
  tabpageListWins(tabpage: Tabpage, notify?: boolean): Promise<Array<Window>>;
  tabpageGetVar(tabpage: Tabpage, name: string, notify?: boolean): Promise<VimValue>;
  tabpageSetVar(tabpage: Tabpage, name: string, value: VimValue, notify?: boolean): Promise<void>;
  tabpageDelVar(tabpage: Tabpage, name: string, notify?: boolean): Promise<void>;
  tabpageGetWin(tabpage: Tabpage, notify?: boolean): Promise<Window>;
  tabpageGetNumber(tabpage: Tabpage, notify?: boolean): Promise<number>;
  tabpageIsValid(tabpage: Tabpage, notify?: boolean): Promise<boolean>;
  uiAttach(width: number, height: number, options: {[key: string]: RPCValue}, notify?: boolean): Promise<void>;
  ...
  command(command: string, notify?: boolean): Promise<void>;
  ...
  eval(expr: string, notify?: boolean): Promise<VimValue>;
  ...
  setCurrentDir(dir: string, notify?: boolean): Promise<void>;
  ...
  setVar(name: string, value: VimValue, notify?: boolean): Promise<void>;
  delVar(name: string, notify?: boolean): Promise<void>;
  ...
  errWriteln(str: string, notify?: boolean): Promise<void>;
  listBufs(notify?: boolean): Promise<Array<Buffer>>;
  getCurrentBuf(notify?: boolean): Promise<Buffer>;
  setCurrentBuf(buffer: Buffer, notify?: boolean): Promise<void>;
  listWins(notify?: boolean): Promise<Array<Window>>;
  getCurrentWin(notify?: boolean): Promise<Window>;
  setCurrentWin(window: Window, notify?: boolean): Promise<void>;
  listTabpages(notify?: boolean): Promise<Array<Tabpage>>;
  ...
  winGetCursor(window: Window, notify?: boolean): Promise<Array<number>>;
  winSetCursor(window: Window, pos: Array<number>, notify?: boolean): Promise<void>;
  ...
  winSetVar(window: Window, name: string, value: VimValue, notify?: boolean): Promise<void>;
  winDelVar(window: Window, name: string, notify?: boolean): Promise<void>;
  ...
  winGetNumber(window: Window, notify?: boolean): Promise<number>;
